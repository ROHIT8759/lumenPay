...
export const networkProvider = {
    ...
    fundTestnetAccount: (publicKey: string) => networkProvider.instance.fundTestnetAccount(publicKey),
    pollTransactionStatus: (hash: string, timeout?: number) => networkProvider.instance.pollTransactionStatus(hash, timeout),
