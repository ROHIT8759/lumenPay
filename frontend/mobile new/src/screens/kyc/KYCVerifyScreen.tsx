...
type NavigationProp = NativeStackNavigationProp<RootStackParamList, 'KYCVerify'>;
...
export default function KYCVerifyScreen() {
  ...
  const handleStartVerification = async () => {
    ...
    try {
      ...
      diditKYC
        .pollForCompletion(walletAddress, {
          intervalMs: 3000,
          timeoutMs: 600000,
  ...
  const renderContent = () => {
    ...
    if (status === 'PENDING') {
      return (
        <Animated.View entering={FadeInUp.delay(200)} style={styles.centerContent}>
          ...
          <Text style={styles.subtitle}>
            Please complete the verification in your browser. This page will
    ...
    return (
      <Animated.View entering={FadeInUp.delay(200)} style={styles.centerContent}>
        ...
        <Text style={styles.subtitle}>
          Complete biometric verification to unlock premium features like stock
          trading and loans.
        </Text>
        ...
        <View style={styles.privacyBox}>
          ...
          <Text style={styles.privacyText}>
            Your biometric data is never stored. Only verification results are
            saved.
          </Text>
        </View>
